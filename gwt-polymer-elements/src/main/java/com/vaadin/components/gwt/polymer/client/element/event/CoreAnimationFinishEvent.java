...
@JsType
public interface CoreAnimationFinishEvent extends Event {

    static final String NAME = "core-animation-finish";


    public abstract class Listener implements EventListener {
        protected abstract void handleEvent(CoreAnimationFinishEvent event);

        @Override
        public void handleEvent(Event event) {
            handleEvent((CoreAnimationFinishEvent) event);
        }
    }
}
