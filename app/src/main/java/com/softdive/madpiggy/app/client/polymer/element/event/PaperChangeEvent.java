...
@JsType
public interface PaperChangeEvent extends Event {

    static final String NAME = "core-change";


    public abstract class Listener implements EventListener {
        protected abstract void handleEvent(PaperChangeEvent event);

        @Override
        public void handleEvent(Event event) {
            handleEvent((PaperChangeEvent) event);
        }
    }
}
