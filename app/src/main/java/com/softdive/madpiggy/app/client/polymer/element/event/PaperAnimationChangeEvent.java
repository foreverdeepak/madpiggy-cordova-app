...
@JsType
public interface PaperAnimationChangeEvent extends Event {

    static final String NAME = "core-animation-change";


    public abstract class Listener implements EventListener {
        protected abstract void handleEvent(PaperAnimationChangeEvent event);

        @Override
        public void handleEvent(Event event) {
            handleEvent((PaperAnimationChangeEvent) event);
        }
    }
}
