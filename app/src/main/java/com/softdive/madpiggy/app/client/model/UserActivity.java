...
public class UserActivity {
	...
	public static enum Activity {
		LIKE, UNLIKE, EARN, SHARE_FACEBOOK, SHARE_GOOGLE_PLUS, SHARE_TWITTER, REVIEW, PARENT_ADDED, CHECK_IN, ORIGINAL_PARENT_INVITATION, CHILD_DELETED, POINTS_TRANSFER, NETWORK_JOINED, CAMPAIGN_CREATED, AD_CREATED;
	}
}
